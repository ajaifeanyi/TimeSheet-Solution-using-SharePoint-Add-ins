...
ReportsRequests = function () {
    var c = function () {
        ...
        , b = function (s, l) {
            ...
            var w = "Id,Created,RequesterName,Id,Status,Created,Period,Year,FirstDayOfPeriod,TotalHours,BillableHoursAmount,BillingAmountTotal,TimeSheetJSON" + m;
        ...
        , e = function (t, q, r, l) {
            ...
            var u = appweburl + "/_vti_bin/ListData.svc/Requests/?$filter=" + o + "&$inlinecount=allpages&$select=Id,Created,RequesterName,Id,Status,Created,Period,FirstDayOfPeriod,Year,TotalHours,BillableHoursAmount,BillingAmountTotal&$orderby=" + q.jtSorting.replace(" DESC", " desc").replace(" ASC", " asc") + "&$skip=" + q.jtStartIndex + "&$top=" + q.jtPageSize;
