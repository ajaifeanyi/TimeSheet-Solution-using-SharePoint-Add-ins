...
SubstituteApproverEdit = function () {
    var e = function () {
        ...
        , f = function (i) {
            var j;
            $.ajax({
                url: appweburl + "/_vti_bin/ListData.svc/SubstituteApprovers?$select=Id,Manager,SubstituteApprover,StartDate,EndDate1,IsActive1&$expand=Manager,SubstituteApprover&$filter=Id eq " + i,
                type: "GET",
                headers: {
                    accept: "application/json;odata=verbose"
                },
...
$(document).ready(function () {
    ...
    if (e == "Edit") {
        ...
        $("#chbIsActive").prop("checked", h.IsActive1)
    } else {
        if (i == "My") {
            $("#sManagerView").show();
    ...
    $("#btnCancel").click(function () {
        location.href = "SubstituteApproversList.html" + (i == "My" ? "?My=true" : "")
    });
    $("#SubstituteApproverEdit").submit(function (j) {
        if ($("#SubstituteApproverEdit").valid()) {
            j.preventDefault();
            var l = {};
            l.qUserId = $("#ddlUser").val();
            ...
            l.IsActive1 = $("#chbIsActive").prop("checked");
