...
TimesheetReport = function () {
    var c = function (h, f) {
        ...
        , e = function (g, f) {
            ...
            var l = appweburl + "/_vti_bin/ListData.svc/Requests/?$filter=" + j + "&$inlinecount=allpages&$select=Id,Created,RequesterName,Id,Statu,Created,Period,Year,TotalHours,BillableHoursAmount,TimeSheetJSON";
