...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script src="../Scripts/jquery.validateEngine.js"></script>
    ...
    <script type="text/javascript" src="../Scripts/Custom/CategoryEdit.js"></script>
    ...
    <div id="containerRight" class="containerRight">
        ...
        <div id="mainContainer" style="clear: both;">
             <div class="maincontent">
                    ...
                    <form id="CategoryEdit" class="stdform stdform2" method="post">
                        ...
                        <div class="blueContainer">
                            ...
                            <p class="control-group" >
                                <label>Title</label>
                                <span class="field" >
                                    <input id="txtTitle" type="text" name="txtTitle" class="input-xlarge" />
                                </span>
                            </p>
