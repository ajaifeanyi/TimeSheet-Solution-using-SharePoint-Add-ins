...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
   ...
   <link rel="stylesheet" href="../Content/bundle.css" type="text/css" />
    ...
    <script type="text/javascript" src="../Scripts/Custom/ProjectsList.js"></script>
    ...
    <div id="containerRight" class="containerRight">
        ...
        <div id="mainContainer" style="clear: both;">
              <span style="margin-top:15px;display:block;">
                     <a id="btnImport" href="ImportProjects.aspx" class="btn">Import</a>
                </span>


            <div style="width: 600px; margin-top: 15px">
                <div class="jtableContainer" id="Projects"></div>
            </div>
        </div>
