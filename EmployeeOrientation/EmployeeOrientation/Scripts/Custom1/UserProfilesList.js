...
UserProfilesList = function () {
    var b = function () {
        ...
        , c = function (e, d) {
            var g;
            var f = appweburl + "/_vti_bin/ListData.svc/UserProfiles/?$inlinecount=allpages&$select=Id,User,Manager,FirstApproverId,FirstApproverName,SecondApproverId,SecondApproverName,UserName,ManagerName,HourlyRate&$orderby=" + d.jtSorting.replace(" DESC", " desc").replace(" ASC", " asc") + "&$skip=" + d.jtStartIndex + "&$top=" + d.jtPageSize;
