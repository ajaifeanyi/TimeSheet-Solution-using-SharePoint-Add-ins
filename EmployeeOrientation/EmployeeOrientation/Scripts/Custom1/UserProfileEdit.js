...
UserProfileEdit = function () {
    var d = function () {
        ...
        , b = function () {
            var h;
            $.ajax({
                url: "https://microdev-31d88d2d3aaf5c.sharepoint.com/sites/RelianceDev/EmployeeOrientation/_vti_bin/ListData.svc/UserRoles/?$inlinecount=allpages&$select=Id,RoleName,EmployeeId,EmployeeName&$filter=RoleName%20eq%20%27Manager%27",
                type: "GET",
                headers: {
                    accept: "application/json;odata=verbose"
                },
    ...
    $("#UserProfileEdit").submit(function (k) {
        if ($("#UserProfileEdit").valid()) {
            ...
            var j = {
                ...
                UserName: $("#ddlUser option:selected").attr("fullName"),
