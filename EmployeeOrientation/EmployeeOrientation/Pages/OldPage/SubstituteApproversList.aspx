...
<link rel="stylesheet" href="../Content/bundle.css" type="text/css" />
    ...
    <link rel="stylesheet" href="../Scripts/jtable/themes/metro/blue/jquery-ui.css" type="text/css" />
    <link rel="stylesheet" href="../Scripts/jtable/themes/metro/blue/jtable.css" type="text/css" />
   <link rel="stylesheet" href="../Content/styles.css" type="text/css" />     
    ...
    <script src="../Scripts/Custom/SubstituteApproversList.js"></script>
...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div id="containerRight" class="containerRight">
        ...
        <div id="topHeader" class="topHeader">
            ...
            <h1>Substitute Aprovals List</h1>
        </div>

        <div id="mainContainer" style="clear: both;">

            <div style="width: 950px; margin-top: 15px">
                <div class="jtableContainer" id="SubstituteApprovers"></div>
            </div> 
        </div>
