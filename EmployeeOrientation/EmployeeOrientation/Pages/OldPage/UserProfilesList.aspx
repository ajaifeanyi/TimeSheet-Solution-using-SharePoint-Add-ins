...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
   ...
   <link rel="stylesheet" href="../Content/styles.css" type="text/css" />     
    ...
    <script type="text/javascript" src="../Scripts/Custom/UserProfilesList.js"></script>
    ...
    <div id="containerRight" class="containerRight">
        ...
        <div id="mainContainer" style="clear: both;">
              ...
              <span style="margin-top:15px;display:block;">
                     <a id="btnImport" href="ImportUserProfiles.aspx" class="btn">Import</a>

                </span>

             <div style="width: 950px; margin-top: 15px">
                <div class="jtableContainer" id="UserProfiles"></div>
            </div>
        </div>
